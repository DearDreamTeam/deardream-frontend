...
const QuitPage = () => {
  ...
  return (
    <>
      <div className="overflow-auto-hide-scroll relative flex h-full w-full flex-col items-center justify-between p-4 pt-0">
            ...
            <div className="text-body-2 text-grey-300 grey-0space-normal">
              {planType === "HOME" ? (
                ...
                <>
                  ...
                  해지되지 않으면 언제든 다시 시작 할 수 있어요. 또힌, PDF 열람
                  및 다운로드 기능은 그대로 유지돼요.
                </>
              )}
            </div>
