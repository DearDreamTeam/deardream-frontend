...
const QuitItem = ({
  ...
  return (
    <div className="text-label-2 mt-4 flex w-full items-center justify-between bg-green-100 px-6 py-4">
      <p>{text}</p>
      <p>{children}</p>
    </div>
  );
...
const QuitPage = () => {
  ...
  return (
    <>
      <div className="flex h-full w-full flex-1 flex-col p-1">
        <Header>회원 탈퇴</Header>

        <div className="flex w-full flex-1 flex-col justify-between gap-6 p-4">
          <div>
